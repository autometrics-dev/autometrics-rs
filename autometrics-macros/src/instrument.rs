use crate::parse::AutometricsArgs;
use percent_encoding::{utf8_percent_encode, NON_ALPHANUMERIC};
use proc_macro2::TokenStream;
use quote::quote;
use std::env;
use syn::{ImplItem, ItemFn, ItemImpl, Result};
...
pub(crate) fn instrument_function(args: &AutometricsArgs, item: ItemFn) -> Result<TokenStream> {
        ...
        quote! {
            {
                ...
                CounterLabels {
                    ...
                    module: module_path!(),
                    caller: CALLER.get(),
                    result: Some((result_label, value_type)),
                }
            }
        }
    } else {
    ...
    Ok(quote! {
        ...
        #vis #sig {
...

            {
                ...
                let histogram_labels = HistogramLabels {
                    function: #function_name,
                    module: module_path!(),
                };
...
pub(crate) fn instrument_impl_block(
